...
StudentId = str(input("Enter the StudentId:")).strip()
...
def calculateEngagement(db, sessionId, StudentId):
    ...
    if eyesOpen == 1 and eyesClose == 0 and lookAway == 1:
        personalEngagementLv = 30
    elif eyesOpen == 0 and eyesClose == 1 and lookAway == 1:
        personalEngagementLv = 0
    elif eyesOpen == 1 and eyesClose == 0 and lookAway == 0:
        personalEngagementLv = 40
    elif eyesOpen == 0 and eyesClose == 1 and lookAway == 0:
